...
final class ConsoleCommandObserver
{
    ...
    private function callStartCallbacks(CommandStarting $event): void
    {
    ...
    private function callFinishCallbacks(CommandFinished $event): void
    {
    ...
    private function invoke(Closure $callback, object $event): mixed
    {
    ...
    private function matches(string $command): bool
    {
        $f = $this->filter;
    ...
    private function matchPattern(string $pattern, string $command): bool
    {
